...
omp:
	ifort -qopenmp -qopenmp-link=static -extend-source 132 -heap-arrays 1000 -module $(MODDIR) -I$(INCDIR) nspcg.f PlumeModels.f -c -static-intel
	ifort -qopenmp -qopenmp-link=static -heap-arrays 1000 -module $(MODDIR) -I$(INCDIR) si3d_types.f90 si3d_stwave.f90 si3d_sed.f90 si3d_Hg.f90 si3d_wq.f90 si3d_ecomod.f90 si3d_utils.f90 si3d_boundaryconditions.f90 si3d_mixing.f90 si3d_procedures.f90 si3d.f90 -c -static-intel
